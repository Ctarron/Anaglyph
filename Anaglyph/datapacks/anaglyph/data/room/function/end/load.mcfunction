...
summon item 101.5 112 420.0 {Age:-32768,Tags:["dynamic"],Item:{id:"minecraft:sand",count:1,components:{"minecraft:item_model":"ctarron:tile","minecraft:item_name":{"fallback":"Vertical slab","translate":"ctarron.slab"},"minecraft:tooltip_display":{hidden_components:["item_model","rarity"]},"minecraft:rarity":"epic"}}}
